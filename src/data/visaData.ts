...
const OUTBOUND_DATA_FROM_SHEET = [
  ...
  { dest: "Australia", time: "20-25 DAYS", gFee: 17500, sFee: 5000, docs: "PASSPORT COPY FIRST AND LAST PAGE, AADHAR CARD, 06 MONTH BANK STATEMENT, 03 YEARS ITR. IF BUSINESS: COMPANY 06 MONTH BANK STATEMENT, 03 YEARS COMPANY ITR, COMPANY REGISTRATION.", formUrl: "https://visa.vfsglobal.com/ind/en/aus/apply-visa" }, // Kept external
  ...
  { dest: "Canada", time: "APPROX 1.5 MONTH", gFee: 14500, sFee: 5000, docs: "PASSPORT COPY, 01 PHOTO, MARRIAGE DATE/PARENTS DOB, OCCUPATION DETAILS, 06 MONTH BANK STATEMENT, 03 YEARS ITR.", formUrl: "https://visa.vfsglobal.com/ind/en/can/apply-visa" }, // Kept external
  ...
  { dest: "Egypt", time: "1-2 WORKING DAYS", gFee: 1675, sFee: 2500, docs: "PASSPORT, 02 PHOTO, TICKET, HOTEL CONFIRMATION", formUrl: "https://visa.vfsglobal.com/ind/en/egy/apply-visa" }, // Kept external
  { dest: "Finland", time: "15 WORKING DAYS", gFee: 12096, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "https://visa.vfsglobal.com/ind/en/fin/apply-visa" }, // Kept external
  ...
  { dest: "Germany", time: "15 WORKING DAYS", gFee: 11865, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "https://visa.vfsglobal.com/ind/en/deu/apply-visa" }, // Kept external
  ...
  { dest: "Jordan", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/jordan.pdf" },
  ...
  { dest: "Morocco", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/morocco.pdf" },
  ...
  { dest: "Philippines", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/philippines.pdf" },
  { dest: "Poland", time: "15 WORKING DAYS", gFee: 11400, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "/forms/poland.pdf" },
  { dest: "Portugal", time: "15 WORKING DAYS", gFee: 11400, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "/forms/portugal.pdf" },
  { dest: "Russia", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/russia.pdf" },
  { dest: "Singapore", time: "3-5 WORKING DAYS", gFee: 1500, sFee: 0, docs: "APPLICATION FORM, ORIGINAL PASSPORT, 02 PHOTO, COVER LETTER, CONFIRMED TICKET, HOTEL, OCCUPATION DETAILS, MONTHLY SALARY, 06 MONTH BANK STATEMENT.", formUrl: "/forms/singapore.pdf" },
  { dest: "South Africa", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/south-africa.pdf" }, // Assumes you rename this file to remove the space
  { dest: "South Korea", time: "10-12 WORKING DAYS", gFee: 4980, sFee: 2500, docs: "APPLICATION FORM, PASSPORT, PHOTO, TICKET, HOTEL, NOC FROM EMPLOYER, 06 MONTH BANK STATEMENT (SEAL/SIGN), 02 YEARS ITR.", formUrl: "https://visa.vfsglobal.com/ind/en/kor/apply-visa" }, // Kept external
  { dest: "Spain", time: "15 WORKING DAYS", gFee: 11450, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "/forms/spain.pdf" },
  { dest: "Sri Lanka", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/sri-lanka.pdf" }, // Assumes you rename this file to remove the space
  { dest: "Sweden", time: "15 WORKING DAYS", gFee: 11900, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "/forms/sweden.pdf" },
  { dest: "Switzerland", time: "15 WORKING DAYS", gFee: 12700, sFee: 2500, docs: "PASSPORT, 02 PHOTO, APPLICATION FORM, REQUEST LETTER, TICKET, HOTEL, TRAVEL INSURANCE, 06 MONTH BANK STATEMENT (SEAL/SIGN), 03 YEARS ITR.", formUrl: "/forms/switzerland.pdf" },
  ...
  { dest: "Thailand", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/thailand.pdf" },
  { dest: "Turkey", time: "5-7 WORKING DAYS", gFee: 18500, sFee: 2500, docs: "VISA APPLICATION, PASSPORT, 02 PHOTO (2.5X2.5 INC), CONFIRMED TICKET, HOTEL VOUCHER, NOC FROM EMPLOYER.", formUrl: "https://visa.vfsglobal.com/ind/en/tur/apply-visa" }, // Kept external
  { dest: "Uganda", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/uganda.pdf" },
  ...
  { dest: "United Arab Emirates", time: "3-4 WORKING DAYS", gFee: 7000, sFee: 2500, docs: "CLEAR PASSPORT COPY FIRST AND LAST PAGE, PAN CARD, PHOTO, HOTEL CONFIRMATION, TICKET", formUrl: "/forms/uae.pdf" }, 
  ...
  { dest: "Vietnam", time: "Contact Support", gFee: 0, sFee: 0, docs: "Please contact Conquest support for updated requirements.", formUrl: "/forms/vietnam.pdf" },
];
