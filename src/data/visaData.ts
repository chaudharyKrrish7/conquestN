...
const OUTBOUND_DATA_FROM_SHEET = [
  ...
  { dest: "South Korea", time: "10-12 WORKING DAYS", gFee: 9030, sFee: 2500, docs: "APPLICATION FORM, PASSPORT, PHOTO, TICKET, HOTEL, NOC FROM EMPLOYER, 06 MONTH BANK STATEMENT (SEAL/SIGN), 02 YEARS ITR.", formUrl: "https://visa.vfsglobal.com/ind/en/kor/apply-visa" },
  ...
  { dest: "Turkey", time: "5-7 WORKING DAYS", gFee: 18120, sFee: 2500, docs: "VISA APPLICATION, PASSPORT, 02 PHOTO (2.5X2.5 INC), CONFIRMED TICKET, HOTEL VOUCHER, NOC FROM EMPLOYER.", formUrl: "https://visa.vfsglobal.com/ind/en/tur/apply-visa" },
