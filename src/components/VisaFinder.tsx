        ...
        {currentPair ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="flex-1 flex flex-col gap-8 w-full">
                    ...
                    >
                      ...
                      <div className="flex justify-between items-start mb-6">
                        ...
                        <div className="text-right flex-shrink-0">
                          ...
                          <span className="text-xs text-gray-400 block uppercase font-semibold mb-1">
                            {opt.currency}
                          </span>
                      ...
                      <div className="grid grid-cols-3 gap-3 border-t border-gray-100 pt-5 text-center text-sm">
                        ...
                        <div className="bg-gray-50/50 p-2 rounded-xl">
                          <span className="text-[10px] text-gray-500 block uppercase tracking-wider font-semibold mb-1">
                            Category
                          </span>
              ...
              {/* Required Documents */}
              {/* Required Documents */}
<div className="bg-white p-8 rounded-3xl border-2 border-blue-500 shadow-md">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    {currentPair.requiredDocuments.map(
      (doc, i) => (
        <div
          key={i}
          className="flex items-start gap-4 bg-gray-50 p-5 rounded-2xl border border-gray-100"
        >
  ...
  {currentPair.applicationFormUrl && (
    <div className="mt-8 pt-6 border-t border-gray-100">
      ...
      <a
        ...
        className="inline-flex items-center gap-3 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 font-bold py-3.5 px-6 rounded-xl transition-colors w-full justify-center md:w-auto shadow-sm"
      >
        ...
        Download Official Application Form
            ...
            {/* IMPORTANT: LEFT COLUMN ENDS HERE */}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-gray-400">
                          ...
                          {baseGovtFee.toLocaleString(
                            "en-IN",
                            {
                              minimumFractionDigits: 2,
                            }
                          )}{" "}
                          × {applicantCount} person
                        </p>
                  ...
                  <div className="flex items-start justify-between group">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-gray-700">
                          Conquest Service Fee
                        </p>

                        <p className="text-[10px] text-gray-400">
                          {activeOption?.currency}{" "}
                          {baseServiceFee.toLocaleString(
                            "en-IN",
                            {
                              minimumFractionDigits: 2,
                            }
